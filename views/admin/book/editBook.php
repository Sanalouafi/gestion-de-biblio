                            ...
                            <div class="bg-dark text-center rounded p-4">
                                ...
                                <div class="container d-flex justify-content-center" style="margin-top:5%;">
                                    <form method="POST" action="../../../App/Controllers/BookController.php" enctype="multipart/form-data" style="width:50vw; min-width:300px;">
                                        ...
                                        <div class="card">
                                            <img src="../<?= $book['photo'] ?>" alt="image" id="image">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" name="title" placeholder="name of the book" value="<?= $book['title'] ?>" required>
                                            </div>

                                            <div class="col">
                                                <label class="form-label">author:</label>
                                                <input type="text" class="form-control" name="author" placeholder="author" value="<?= $book['author'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">genre:</label>
                                            <input type="text" class="form-control" name="genre" placeholder="genre of the book" value="<?= $book['genre'] ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">description:</label>
                                            <input type="text" class="form-control" name="description" placeholder="description of the book" value="<?= $book['description'] ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">publication year:</label>
                                            <input type="date" class="form-control" name="publication_year" placeholder="publication year" value="<?= $book['publication_year'] ?>" required>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col">
                                                <label class="form-label">total copie:</label>
                                                <input type="number" class="form-control" name="total_copie" placeholder="total copie" value="<?= $book['total_copie'] ?>" required>
                                            </div>
                                        ...
                                        <div class="row ms-1 mt-4 justify-content-center">
                                            <button type="submit" name="edit_book_submit" class="btn btn-success col-3 me-3">Save changes</button>
